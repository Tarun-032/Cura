...
/// Persists Ask conversations in the local database.
class ChatRepository {
  ...
  /// Appends a message and updates the session.
  ...
  /// Removes the newest [count] messages.
  ...
  StoredMessage _toMessage(ChatMessageRow row) => StoredMessage(
    ...
    role: switch (row.role) {
      ...
      'notice' => ChatRole.notice,
      // Anything unknown reads as a question, as it always has.
      _ => ChatRole.user,
    },
    text: row.content,
